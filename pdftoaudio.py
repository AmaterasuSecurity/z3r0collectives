...
with open(/Users/alvin/Desktop/CCNA 200-301 Official Cert Guide Voulme 1.pdf, "rb") as f:  # open the file in reading (rb) mode and call it f
...
final_file.save("CCNAv1.mp3")  # save file to computer